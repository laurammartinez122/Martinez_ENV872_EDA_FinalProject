...
```{r EPA air quality dataset wrangling into three df's}
...
```{r Convert EPA air quality dataframe to sf}
PM.sf <- PM_combined %>% 
...
mapview(CO_and_Ozone.sf)

mapview(NO2_and_SO2.sf)
